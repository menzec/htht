...
def arg_parse():
    ...
    parser.add_argument(
        '-e', '--epoch', default=100, type=int, help="total epoch")
...
def main():
    ...
    net.load_state_dict(torch.load("./net_058.pth"))
    for param in net.parameters():
        param.requires_grad = False
        if len(param.shape) == 2 and param.shape[0] == 21 and param.shape[1]==2048:
            print("found")
